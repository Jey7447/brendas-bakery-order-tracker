    ...
    <div className="dashboard-shell">
      ...
      <main className="dashboard-main">
        ...
        <section className="stats">
          <div className="stat-card"><span>Today&apos;s orders</span><strong>{todayCount}</strong><small>Delivery date: 10 Sep</small></div>
          <div className="stat-card accent"><span>Unpaid today</span><strong>{todayUnpaid}</strong><small>{todayUnpaid ? "Needs attention" : "All clear"}</small></div>
          <div className="stat-card"><span>Today&apos;s order value</span><strong>{money(todayRevenue)}</strong><small>Across today&apos;s orders</small></div>
        </section>
        ...
        <section className="orders-card">
          ...
          <div className="order-list">
            ...
            {sorted.length===0 && <div className="no-orders"><CalendarDays size={28}/><strong>No orders here.</strong><span>Try another view or search.</span></div>}
          </div>
        </section>
      </main>
